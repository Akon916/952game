...
class BCS_RequestCore {
	...
	/**
	 * RegisterController.class a callback function to execute whenever a data stream is read from using
	...
	/**
	 * RegisterController.class a callback function to execute whenever a data stream is written to using
